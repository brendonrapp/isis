...
class Isis::Plugin::RandomResponses < Isis::Plugin::Base
  ...
  REGEXPS = [
    ...
    [/\bgithub\s/i, "http://1.bp.blogspot.com/-IpYLCdp3mvg/ThljXpv9VEI/AAAAAAAAAEU/XXH6gWP5wMk/s320/o6pi.jpg"],
    ...
    [/\bJustine\b/i, "https://s3.amazonaws.com/uploads.hipchat.com/1859/39314/dmxijxmoatvhbvp/beautiful-mind.jpg"],
    [/\binternet explorer\b/i, "http://www.vonnieda.org/images/Hahaha.jpg"],
    [/\b(new server|free fios)\b/i, "http://i.imgur.com/wYqtu.jpg"],
    [/\b^(?!\!)portals?\b/i, "http://www.thinkgeek.com/images/products/additional/carousel/e71c_plush_portal_turret_cuddle.jpg"],
    [/\b(Doug Crockford|Crockford|80020101)\b/i, "http://www.acm.uiuc.edu/conference/2009/speakers/images/crockford.png","(yuno) ;"],
    [/\bdone crab\b/i, "http://i.imgur.com/hUGXu.jpg"],
    [/\binstagram\b/i, "http://i.imgur.com/aIT0m.png"],
    [/\b(feature|scope) creep\b/i, "http://ignorethecode.net/upload/38/novelty.jpg"],
    [/\bcloud\b/i, "https://s3.amazonaws.com/uploads.hipchat.com/1859/39314/ulu9acnoa8n3n1k/upload.png"],
    [/\bjackendoff\b/i, "http://upload.wikimedia.org/wikipedia/commons/thumb/e/e4/Ray_Jackendoff.jpg/180px-Ray_Jackendoff.jpg", "While rejecting mainstream generative grammar due to its syntactocentrism, the cognitive semantics school has offered an insight that Jackendoff would sympathize with, namely, that meaning is a separate combinatorial system not entirely dependent upon syntax. Unlike many of the cognitive semantics approaches, he contends that neither syntax alone should determine semantics, nor vice-versa. Syntax need only interface with semantics to the degree necessary to produce properly ordered phonological output."],
    [/\bserver beach\b/i, "http://imgur.com/GK8la"],
    [/\brule 3\b/i, "http://i.imgur.com/uTtZm.png"],
    [/\bdown with the internet\b/i, ["May 21, 2012 04:14 am","https://s3.amazonaws.com/uploads.hipchat.com/1859/39316/z8x37xwgbqgj3xd/best-day-ever.png","http://www.theverge.com/2012/5/21/3033566/chrome-most-popular-browser-weekly-may-2012"]],
    [/\b(i need that|take my money)\b/i, "http://media.tumblr.com/tumblr_m3thrqqYOo1qfssyl.jpg"],
